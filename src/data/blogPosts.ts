  ...
  pl: [
    {
      ...
      content: `
        ...
        <ul>
          ...
          <li>Bezpieczeństwo i niezależność energetyczna</li>
        ...
        <p><strong>Zaznacz w calendarzu 24-26 kwietnia 2025 i dołącz do ASPOL w Sciences Po Paris i Ambasadzie Polski na trzy dni, które mogą ukształtować Twoje rozumienie współpracy europejskiej.</strong></p>
      `
    }
  ],
};
