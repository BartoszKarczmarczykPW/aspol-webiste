  ...
  en: [
    {
      ...
      content: `
        ...
        <p>The 7th edition marks a special milestone�not just as ASPOL's flagship event, but as a platform to discuss Poland's vision for Europe at a critical moment in EU history.</p>
        ...
        <p>The 2025 forum's theme directly addresses Poland's upcoming role as the EU Council Presidency. This is not just about policy�it's about vision. How can Poland and France, two nations with deep historical ties and shared European values, work together to tackle the continent's most pressing challenges?</p>
        ...
        <p>The opening panel tackles one of Europe's defining challenges: how to balance environmental sustainability with economic competitiveness. The green transition is not just an environmental imperative�it's an economic opportunity that requires innovative thinking and cross-border cooperation.</p>
        
        <p><strong>Confirmed Panelists:</strong></p>
        <ul>
          <li><strong>François Gemenne</strong> - Renowned climate scientist and political expert, member of the IPCC, and professor at Sciences Po Paris</li>
  ...
  fr: [
    {
      ...
      excerpt: "Rejoignez-nous pour la 7ème édition du Paris Polish Forum du 24 au 26 avril 2025. Explorez les priorités de la Présidence polonaise de l'UE, l'innovation verte et la coopération franco-polonaise à Sciences Po Paris et à l'Ambassade de Pologne.",
      author: "Équipe ASPOL",
      date: "Mars 2025",
      category: "Actualités",
      ...
      featured: true,
      content: `
        <p>Le Paris Polish Forum revient pour sa septième édition avec une vision ambitieuse qui ne pourrait être plus opportune. Alors que la Pologne se prépare à assumer la Présidence du Conseil de l'UE au premier semestre 2025, l'Association des Étudiants Polonais en France (ASPOL) réunit étudiants, professionnels et leaders d'opinion pour trois journées de dialogue, de networking et d'innovation sous le thème <strong>« Vision de la Pologne pour l'UE : Unis pour un Avenir Innovant. »</strong></p>
        ...
        <ul>
          ...
          <li><strong>26 avril :</strong> Ambassade de Pologne à Paris</li>
        </ul>
        ...
        <ul>
          <li><strong>Durabilité :</strong> Réaliser une Europe verte et compétitive</li>
          <li><strong>Innovation :</strong> Favoriser l'avancement technologique et l'entrepreneuriat</li>
          <li><strong>Culture :</strong> Renforcer les liens culturels qui unissent les nations européennes</li>
        </ul>
        ...
        <ul>
          <li><strong>François Gemenne</strong> - Scientifique du climat renommé, membre du GIEC, professeur à Sciences Po Paris</li>
          <li><strong>Romain Le Creff</strong> - Membre du Bureau du Développement Durable chez Iliad Group</li>
          <li><strong>Magdalena Sajdak</strong> - Experte polonaise en transition énergétique</li>
          <li><strong>Martyna Zastawna</strong> - Experte en innovation et technologies vertes</li>
        </ul>

        <h3>Pourquoi Ce Forum Est Important</h3>
        <p><strong>Pour les Étudiants :</strong> Le Paris Polish Forum offre des opportunités de networking inégalées. Pour les étudiants polonais en France et les étudiants français intéressés par les affaires polonaises, c'est une chance unique de développer votre réseau et votre compréhension de l'Europe.</p>
        
        <p><strong>Pour les Professionnels :</strong> Le forum offre une plateforme pour identifier des opportunités de partenariat et élargir les réseaux professionnels au-delà des frontières.</p>
        
        <p><strong>Pour la Communauté Franco-Polonaise :</strong> Cet événement renforce les liens entre deux nations qui partagent une longue histoire d'échanges culturels et de valeurs partagées.</p>

        <h3>Le Contexte : La Présidence Polonaise de l'UE</h3>
        <p>La Présidence polonaise du Conseil de l'UE au premier semestre 2025 représente un moment significatif. La présidence arrive à un moment critique avec l'UE poursuivant ses engagements de transition verte et l'innovation technologique redéfinissant les économies.</p>
        
        <p>La vision de la Pologne met l'accent sur :</p>
        <ul>
          <li>La croissance tirée par l'innovation</li>
          <li>Le développement durable</li>
          <li>La sécurité et l'indépendance énergétique</li>
          <li>Le renforcement de la cohésion de l'UE</li>
        </ul>

        <h3>Comment Participer</h3>
        <p>Le Paris Polish Forum accueille les étudiants, les jeunes professionnels, les académiques, les dirigeants d'entreprises et toute personne intéressée par les relations franco-polonaises.</p>
        
        <p><strong>Inscription :</strong> Les détails seront annoncés sur le site officiel d'ASPOL et les réseaux sociaux. L'inscription anticipée est recommandée.</p>
        ...
        <p><strong>Notez dans vos agendas les 24-26 avril 2025, et rejoignez ASPOL à Sciences Po Paris et à l'Ambassade de Pologne pour trois jours qui pourraient façonner votre compréhension de la coopération européenne.</strong></p>
      `
    }
  ],
  ...
  pl: [
    {
      ...
      excerpt: "Dołącz do nas na 7. edycji Paris Polish Forum 24-26 kwietnia 2025. Poznaj priorytety Polskiej Prezydencji UE, zieloną innowację i współpracę polsko-francuską w Sciences Po Paris i Ambasadzie Polski.",
      author: "Zespół ASPOL",
      date: "Marzec 2025",
      ...
      featured: true,
      content: `
        <p>Paris Polish Forum wraca z siódmą edycją i ambicyjną wizją, która nie mogłaby być bardziej aktualna. Gdy Polska przygotowuje się do objęcia Prezydencji Rady UE w pierwszej połowie 2025 roku, Stowarzyszenie Studentów Polskich we Francji (ASPOL) łączy studentów, profesjonalistów i liderów opinii na trzy dni dialogu, networkingu i innowacji pod hasłem <strong>„Wizja Polski dla UE: Zjednoczeni dla Innowacyjnego Jutra”</strong>.</p>
        ...
        <ul>
          ...
          <li><strong>26 kwietnia:</strong> Ambasada Polski w Paryżu</li>
        </ul>
        ...
        <ul>
          <li><strong>Zrównoważony Rozwój:</strong> Osiągnięcie zielonej i konkurencyjnej Europy</li>
          <li><strong>Innowacje:</strong> Wspieranie postępu technologicznego i przedsiębiorczości</li>
          <li><strong>Kultura:</strong> Wzmacnianie więzi kulturowych łączących narody europejskie</li>
        </ul>
        ...
        <ul>
          <li><strong>François Gemenne</strong> - Renomowany naukowiec klimatyczny, członek IPCC, profesor w Sciences Po Paris</li>
          <li><strong>Romain Le Creff</strong> - Członek Biura Zrównoważonego Rozwoju w Iliad Group</li>
        ...
        <h3>Dlaczego To Forum Jest Ważne</h3>
        <p><strong>Dla Studentów:</strong> Paris Polish Forum oferuje niezrównane możliwości networkingu. Dla polskich studentów we Francji i francuskich studentów zainteresowanych sprawami polskimi, to szansa na rozwijanie kariery i budowanie trwałych relacji.</p>
        
        <p><strong>Dla Profesjonalistów:</strong> Forum oferuje platformę do identyfikacji możliwości partnerstwa i rozszerzania sieci kontaktów zawodowych ponad granicami.</p>
        
        <p><strong>Dla Społeczności Polsko-Francuskiej:</strong> To wydarzenie wzmacnia więzi między dwoma narodami, które łączy długa historia wymiany kulturalnej i wspólnych wartości.</p>

        <h3>Kontekst: Polska Prezydencja UE</h3>
        <p>Polska Prezydencja Rady UE w pierwszej połowie 2025 roku reprezentuje znaczący moment. Prezydencja nadchodzi w krytycznym momencie, gdy UE kontynuuje zobowiązania dotyczące zielonej transformacji, a innowacje technologiczne przekształcają gospodarki.</p>
        
        <p>Wizja Polski podkreśla:</p>
        <ul>
          <li>Wzrost napędzany innowacjami</li>
          <li>Zrównoważony rozwój</li>
          <li>Bezpieczeństwo i niezależność energetyczną</li>
          <li>Wzmacnianie spójności UE</li>
        </ul>

        <h3>Jak Wziąć Udział</h3>
        <p>Paris Polish Forum wita studentów, młodych profesjonalistów, akademików, liderów biznesu i każdego zainteresowanego relacjami polsko-francuskimi.</p>
        
        <p><strong>Rejestracja:</strong> Szczegóły zostaną ogłoszone na oficjalnej stronie ASPOL i w mediach społecznościowych. Zalecana jest wczesna rejestracja.</p>
        ...
        <p><strong>Zaznacz w kalendarzu 24-26 kwietnia 2025 i dołącz do ASPOL w Sciences Po Paris i Ambasadzie Polski na trzy dni, które mogą ukształtować Twoje rozumienie współpracy europejskiej.</strong></p>
      `
    }
  ],
};
