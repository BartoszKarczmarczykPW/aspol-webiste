            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3.5 text-base border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all touch-manipulation ${
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-3.5 text-base border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all resize-none touch-manipulation ${
